package com.problems.learning.designpatterns.creational.singleton.attack.impl.enumeration;

import com.problems.learning.designpatterns.creational.singleton.attack.FakeSingletonDetectorAttack;
import com.problems.learning.designpatterns.creational.singleton.attack.util.CustomClassLoader;
...
public class ClassLoaderAttack implements FakeSingletonDetectorAttack {
    ...
    public static final String fqcn = "org.practice.designpatterns.creational.singleton.impl.EnumSingleton";
