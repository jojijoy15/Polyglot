package com.problems.learning.fooddelivery;
...
public class RideDispatcherExecutorServiceSystem {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Future<?> riderTask = executorService.submit(riderAssignor);
        Future<?> orderTask = executorService.submit(orderCompletor);
