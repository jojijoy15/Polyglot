...
class StreamsProblemsTest {
    ...
    public void mergeByValue() {
        Map<String, String> empCityMap = new HashMap<>();
        empCityMap.put("John", "Hyderabad");
        empCityMap.put("Sara", "Bangalore");
        empCityMap.put("Mike", "Hyderabad");
        empCityMap.put("David", "Bangalore");
        empCityMap.put("Neha", "Chennai");
        Map<String, List<String>> employeesByCity = sp.mergeByValue(empCityMap);
        assertThat(employeesByCity)
        .containsExactlyInAnyOrderEntriesOf(
                        Map.of("Hyderabad",  List.of("Mike", "John"),
                                "Bangalore", List.of("David", "Sara"),
                                "Chennai",  List.of("Neha")
                        )
                );
    }
}